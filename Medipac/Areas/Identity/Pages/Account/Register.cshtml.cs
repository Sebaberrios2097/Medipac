    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Asignar las propiedades adicionales (que no vienen en el modelo original de ASP
                user.IdEstado = 2;
                user.IsAdmin = false;
        ...
        private ComUsuario CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(ComUsuario)}'. " +
                    $"Ensure that '{nameof(ComUsuario)}' is not an abstract class and has a parameterless constructor, or alternatively " +
